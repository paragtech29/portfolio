  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.75 0.18 220), transparent 70%)",
          filter: "blur(80px)",
          y: backgroundY,
        }}
      />
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.55 0.25 290), transparent 70%)",
          filter: "blur(80px)",
          y: backgroundY,
        }}
      />
      ...
      <div className="relative mx-auto max-w-4xl" ref={ref}>
        ...
        >
          ...
          >
            {"Let's Build".split("").map((char, i) => (
              <motion.span
                ...
                animate={
                  isInView ? { opacity: 1, y: 0, rotateX: 0 } : undefined
                }
                transition={{
                  delay: 0.3 + i * 0.03,
                  duration: 0.5,
          ...
          >
            Got a project in mind? Let&apos;s talk about how we can work
            together.
          </motion.p>
        </motion.div>
